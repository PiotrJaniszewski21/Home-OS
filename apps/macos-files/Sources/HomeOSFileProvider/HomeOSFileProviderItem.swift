...
final class HomeOSFileProviderItem: NSObject, NSFileProviderItem {
    ...
    init(
        ...
        self.capabilities = capabilities ?? (isDirectory
    ...
    static func from(
        ...
        let identifier = HomeOSFileProviderPath.identifier(for: remotePath, identityStore: identityStore)
        return HomeOSFileProviderItem(
            itemIdentifier: identifier,
            parentItemIdentifier: HomeOSFileProviderPath.parentIdentifier(for: remotePath, identityStore: identityStore),
            filename: entry.name,
    ...
    var snapshot: HomeOSFileProviderSnapshot {
