...
enum HomeOSFileProviderPath {
    ...
    static func identifier(for path: String) -> NSFileProviderItemIdentifier {
        ...
        return normalized == "/" ? .rootContainer : NSFileProviderItemIdentifier(normalized)
    }

    static func remotePath(for identifier: NSFileProviderItemIdentifier) throws -> String {
    ...
    static func parentIdentifier(for path: String) -> NSFileProviderItemIdentifier {
        identifier(for: parentPath(for: path))
    }
